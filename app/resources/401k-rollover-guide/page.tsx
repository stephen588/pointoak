...
export const metadata: Metadata = {
  title: "401(k) Rollover Guide | Protect Your Retirement Savings | PointOak",
  description: "Learn how to roll over your 401(k) without paying unnecessary taxes or penalties. This guide covers direct rollovers, IRA options, tax implications, and common mistakes to avoid.",
  openGraph: {
    title: "401(k) Rollover Guide | PointOak",
    description: "How to protect your retirement savings when changing jobs. Understand direct rollovers, IRA options, and tax implications.",
    url: "https://www.pointoak.com/resources/401k-rollover-guide/",
  },
};

const tocItems = [
  { id: "what-is-rollover", label: "What Is a 401(k) Rollover?" },
  { id: "direct-vs-indirect", label: "Direct Rollover vs. Indirect Rollover" },
  { id: "rolling-to-new-plan", label: "Rolling Into a New Employer&apos;s Plan" },
  { id: "rolling-to-ira", label: "Rolling Into an IRA" },
  { id: "old-plan", label: "What to Do With Your Old Plan" },
  { id: "cash-out-mistake", label: "The Cash-Out Mistake" },
  { id: "rmds", label: "Required Minimum Distributions" },
...
const jsonLd = [
  {
    ...
    "@type": "Article",
    headline: "401(k) Rollover Guide: How to Protect Your Retirement Savings When Changing Jobs",
    description: "Comprehensive guide to 401(k) rollovers covering direct vs indirect transfers, IRA options, tax implications, and common mistakes to avoid.",
    url: "https://www.pointoak.com/resources/401k-rollover-guide/",
    publisher: {
      "@type": "Organization",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="How to Protect Your Retirement Savings When Changing Jobs"
      />
        ...
        <div className="max-w-[1170px] mx-auto px-6 xl:px-0">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <article className="flex-1 min-w-0">
              ...
              <div id="what-is-rollover" className="scroll-mt-8 mb-12">
                ...
                <ul className="list-disc list-inside font-outfit text-dark-gray text-base leading-relaxed mb-4 space-y-2">
                  <li>Roll your old 401(k) into your new employer&apos;s plan</li>
                  <li>Roll it into a rollover IRA (traditional IRA or Roth IRA)</li>
                  <li>Leave the money in your former employer&apos;s plan</li>
                  <li>Cash out the entire balance (which we strongly advise against)</li>
                </ul>
              ...
              <div id="direct-vs-indirect" className="scroll-mt-8 mb-12">
                ...
                <h3 className="font-outfit text-navy text-xl font-medium mb-3">Direct Rollover (Trustee-to-Trustee Transfer)</h3>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-6">
                ...
                <h3 className="font-outfit text-navy text-xl font-medium mb-3">Indirect Rollover</h3>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-4">
              ...
              <div id="rolling-to-new-plan" className="scroll-mt-8 mb-12">
                <h2 className="font-outfit text-navy text-2xl md:text-3xl font-light mb-4">
                  Rolling Into a New Employer&apos;s Plan
                </h2>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside font-outfit text-dark-gray text-base leading-relaxed space-y-2">
                  <li>Continued tax-deferred growth on pre-tax contributions</li>
                  <li>Potential access to institutional investment choices with lower annual fees</li>
                  <li>The ability to take penalty-free withdrawals through certain plan provisions that IRAs don&apos;t offer (such as the age-55 separation rule)</li>
                </ul>
              </div>

              {/* Rolling Into an IRA */}
              <div id="rolling-to-ira" className="scroll-mt-8 mb-12">
                <h2 className="font-outfit text-navy text-2xl md:text-3xl font-light mb-4">
                  Rolling Into an IRA
                </h2>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-6">
                ...
                <h3 className="font-outfit text-navy text-xl font-medium mb-3">Traditional IRA Rollover</h3>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-6">
                ...
                <h3 className="font-outfit text-navy text-xl font-medium mb-3">Roth IRA Rollover (Roth Conversion)</h3>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-4">
              ...
              <div id="old-plan" className="scroll-mt-8 mb-12">
                <h2 className="font-outfit text-navy text-2xl md:text-3xl font-light mb-4">
                  What to Do With Your Old Plan
                </h2>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-4">
              ...
              <div id="cash-out-mistake" className="scroll-mt-8 mb-12">
                <h2 className="font-outfit text-navy text-2xl md:text-3xl font-light mb-4">
                  The Cash-Out Mistake
                </h2>
                <p className="font-outfit text-dark-gray text-base leading-relaxed mb-4">
              ...
              <div id="rmds" className="scroll-mt-8 mb-12">
                <h2 className="font-outfit text-navy text-2xl md:text-3xl font-light mb-4">
