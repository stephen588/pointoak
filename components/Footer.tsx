  ...
  return (
    <footer className="bg-navy">
      <div className="max-w-[1170px] mx-auto px-6 xl:px-0 py-12 md:py-16">
        {/* Get In Touch */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 md:gap-16 mb-10 md:mb-12">
          {/* Left — Logo + tagline */}
          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-16">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-outfit text-white text-sm font-medium">Address</span>
              </div>
              <a
                href="https://maps.google.com/?q=1751+Pinnacle+Drive+Suite+600+McLean+VA+22102"
                target="_blank"
                rel="noopener noreferrer"
                className="font-outfit text-white/80 text-sm leading-6 hover:text-white transition-colors"
              >
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-outfit text-white text-sm font-medium">Phone</span>
                </div>
                <a href="tel:+17035954444" className="font-outfit text-white/80 text-sm hover:text-white transition-colors">
                  (703) 595-4444
                </a>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-outfit text-white text-sm font-medium">Email</span>
                </div>
                <a href="mailto:info@pointoak.com" className="font-outfit text-white/80 text-sm hover:text-white transition-colors">
                  info@pointoak.com
                </a>
              </div>
            </div>
        ...
        <div className="bg-medium-blue rounded-[30px] p-6 md:p-10 mb-6 md:mb-8">
          <div className="max-w-[1095px]">
            ...
            <div className="font-outfit text-white/85 text-xs md:text-sm leading-relaxed space-y-3 md:space-y-4">
              ...
              <p>
                PointOak Retirement Advisors LLC is a Registered Investment Adviser located in
                Northern Virginia. Advisory services are only offered to clients where properly
                licensed or exempt. Investing involves risk, including the loss of principal; past
                performance does not guarantee future results. Registration does not imply a certain
                level of skill or training. Additional information is available at{" "}
                <a
              ...
              <p className="flex flex-wrap gap-x-2 gap-y-1">
                ...
                <a
                  href="/disclosures/form-adv-2a.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline hover:text-white/80 transition-colors"
                >
                ...
                <span aria-hidden="true">|</span>
                <a
                  href="/disclosures/privacy-statement.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline hover:text-white/80 transition-colors"
                >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-outfit text-white text-xs md:text-sm">
