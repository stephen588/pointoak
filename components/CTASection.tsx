...
export default function CTASection() {
  ...
  return (
    <section id="contact" className="bg-navy py-12 md:py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="max-w-[1170px] mx-auto px-6 xl:px-0 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-14">
          ...
          <div className="bg-white/[0.07] border border-white/10 rounded-lg p-8 flex items-center gap-5">
            ...
            <div>
              <div className="font-outfit text-white font-bold text-lg mb-1">Call Us</div>
              <a href="tel:+17035954444" className="font-outfit text-white/80 text-base hover:text-white transition-colors">
                (703) 595-4444
              </a>
            </div>
          </div>
          ...
          <div className="bg-white/[0.07] border border-white/10 rounded-lg p-8 flex items-center gap-5">
            ...
            <div>
              <div className="font-outfit text-white font-bold text-lg mb-1">Email Us</div>
              <a href="mailto:info@pointoak.com" className="font-outfit text-white/80 text-base hover:text-white transition-colors">
                info@pointoak.com
              </a>
            </div>
          </div>
          ...
          <div className="bg-white/[0.07] border border-white/10 rounded-lg p-8 flex items-center gap-5">
            ...
            <div>
              <div className="font-outfit text-white font-bold text-lg mb-1">Visit</div>
              <a 
                href="https://maps.google.com/?q=1751+Pinnacle+Drive+Suite+600+McLean+VA+22102" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="font-outfit text-white/80 text-base leading-snug hover:text-white transition-colors"
              >
